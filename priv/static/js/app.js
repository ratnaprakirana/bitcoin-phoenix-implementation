...
require.register("css/script.js", function(exports, require, module) {
"use strict";

// Our labels along the x-axis
var years = [1500, 1600, 1700, 1750, 1800, 1850, 1900, 1950, 1999, 2050]; // For drawing the lines
...
var _single_socket = _interopRequireDefault(require("./single_socket"));
...
require.register("js/single_socket.js", function(exports, require, module) {
"use strict";
...
var maxClients = 1;
var userFollowers = {};
var userNamesList = []; //let userName

var messageContainer = document.querySelector('#messages');
var messageContainer1 = document.querySelector('#messages1');
var messageContainer2 = document.querySelector('#messages2');
...
socket.connect();
channel = socket.channel("room:lobby", {}); //join the new client
...
document.getElementById('start_mining').onclick = function () {
...
channel.on("start_mining", function (payload) {
  console.log(payload.bitcoined);
  var messageItem = document.createElement("li");
  messageItem.innerText = " ".concat(payload.bitcoined);
  messageContainer.appendChild(messageItem);
});
channel.on("start_trans", function (payload) {
  console.log(payload.bitcoined);
  var messageItem = document.createElement("li");
  messageItem.innerText = " ".concat(payload.bitcoined);
  messageContainer1.appendChild(messageItem);
});
channel.on("wallet_det", function (payload) {
  console.log(payload.bitcoined);
  var messageItem = document.createElement("li");
  messageItem.innerText = " ".concat(payload.bitcoined);
  messageContainer2.appendChild(messageItem);
});
channel.on("mining_list", function (payload) {
  var list = payload.bitcoined;
  console.log(list);
  console.log("gdsfgdfdfhfghfghdfhdfd");
  console.log(list[2][1]);
  new Chart(document.getElementById("bar-chart"), {
    type: 'bar',
    data: {
      labels: [list[1][1], list[2][1], list[3][1], list[4][1], list[5][1], list[6][1], list[7][1], list[8][1], list[9][1], list[10][1], list[11][1], list[12][1], list[13][1], list[14][1], list[15][1], list[16][1], list[17][1], list[18][1], list[19][1], list[20][1], list[21][1], list[22][1], list[23][1], list[24][1], list[25][1]],
      datasets: [{
        label: "BTC",
        ...
        data: [list[1][0], list[2][0], list[3][0], list[4][0], list[5][0], list[6][0], list[7][0], list[8][0], list[9][0], list[10][0], list[11][0], list[12][0], list[13][0], list[14][0], list[15][0], list[16][0], list[17][0], list[18][0], list[19][0], list[20][0], list[21][0], list[22][0], list[23][0], list[24][0], list[25][0]]
      }]
    },
    options: {
      legend: {
      ...
      title: {
        display: true,
        text: 'Bitcoin distribution per participant'
      },
      scales: {
        yAxes: [{
          ticks: {
        ...
        xAxes: [{
          scaleLabel: {
            display: true,
            labelString: 'Participant public keys'
          }
        }]
      }
    }
...
channel.on("trans", function (payload) {
  var list = payload.bitcoined;
  console.log(list);
  console.log("gdsfgdfdfhfghfghdfhdfd");
  console.log(list[2][1]);
  new Chart(document.getElementById("bar-chart1"), {
    type: 'bar',
    data: {
      labels: [list[1][0], list[2][0], list[3][0], list[4][0], list[5][0], list[6][0], list[7][0], list[8][0], list[9][0], list[10][0], list[11][0], list[12][0], list[13][0], list[14][0], list[15][0], list[16][0], list[17][0], list[18][0], list[19][0], list[20][0], list[21][0], list[22][0], list[23][0], list[24][0], list[25][0]],
      datasets: [{
        scaleBeginAtZero: true,
        label: "BTC transacted",
        backgroundColor: ["#3e95cd", "#8e5ea2", "#3cba9f", "#e8c3b9", "#c45850", "#3e95cd", "#8e5ea2", "#3cba9f", "#e8c3b9", "#c45850", "#3e95cd", "#8e5ea2", "#3cba9f", "#e8c3b9", "#c45850", "#3e95cd", "#8e5ea2", "#3cba9f", "#e8c3b9", "#c45850", "#3e95cd", "#8e5ea2", "#3cba9f", "#e8c3b9", "#c45850"],
        data: [list[1][3], list[2][3], list[3][3], list[4][3], list[5][3], list[6][3], list[7][3], list[8][3], list[9][3], list[10][3], list[11][3], list[12][3], list[13][3], list[14][3], list[15][3], list[16][3], list[17][3], list[18][3], list[19][3], list[20][3], list[21][3], list[22][3], list[23][3], list[24][3], list[25][3]]
      }]
    },
    options: {
      legend: {
      ...
      title: {
        display: true,
        text: 'Bitcoin transacted per transaction '
      },
      scales: {
        yAxes: [{
          ticks: {
        ...
        xAxes: [{
          scaleLabel: {
            display: true,
            labelString: 'Transaction ID of each transaction'
          }
        }]
      }
    }
